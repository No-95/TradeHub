...
const pkg = {
  title: "CORE",
  subtitle: "Expo access, market immersion, and program support.",
  price: "Contact for price",
  features: [
    "Korea Seafood Show 2026 entry ticket",
    "Market immersion tour and trade fair access",
    "Shared interpretation services for group activities",
    "Briefing and pitch preparation support",
  ],
};
