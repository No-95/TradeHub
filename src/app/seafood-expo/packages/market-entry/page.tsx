...
const pkg = {
  title: "MARKET ENTRY",
  subtitle: "Custom market entry strategy and partner negotiation support.",
  price: "Contact for price",
  features: [
    "Dedicated deal-making session",
    "Legal and MOU support",
    "Logistics and payment infrastructure advisory",
    "Tailored market research and personalized report",
  ],
};
